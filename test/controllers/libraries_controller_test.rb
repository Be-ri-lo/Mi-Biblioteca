...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { author: @library.author, date: @library.date, name: @library.name, status: @library.status, title: @library.title } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { author: @library.author, date: @library.date, name: @library.name, status: @library.status, title: @library.title } }
